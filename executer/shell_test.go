...
executer:
  shell:
    command: curl -v -X POST -H "crab-http-executer:D79DCF87-595A-4B18-B76F-9BD8277C35EF" -d "test hello" 127.0.0.1:8181/task #command和args的作用是等价的，唯一的区别是命令放在一个字符串或者slice里面。
  `
